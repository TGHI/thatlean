...
$output = '<input type="text" name="q" id="mod-finder-searchword" placeholder="Search..." size="' . $params->get('field_size', 20) . '" />';
...
{
	$button = '<button class="btn btn-menu ' . $suffix . ' finder' . $suffix . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><span class="glyphicon glyphicon-search"></span></button>';
